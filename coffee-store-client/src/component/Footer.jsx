...
const Footer = () => {
    return (
        <div
            style={{
                backgroundImage: `url('/resources/images/more/13.jpg')`,
        ...
        >
            <div className="container mx-auto p-20 flex flex-col md:flex-row gap-10 items-center justify-between">
                <div className="space-y-6">
                    <img
                        src="/resources/images/more/logo1.png"
                        alt=""
                        className="h-15 w-15"
                    />
                    ...
                    <h1 className="rancho-regular text-black text-3xl">
                        Get in Touch
                    </h1>
            ...
            <div
                style={{
                    backgroundImage: `url('/resources/images/more/24.jpg')`,
                    backgroundSize: "cover",
                    backgroundPosition: "center",
                }}
            >
